	...
	<body style="background-image: url('images/bigback.jpg');">
		...
		<div class="guidelines">
			...
			<p><strong>Your abstract should be organized in the following four sections, each with its own sub-heading:</strong><br>
				Please note, the character limit for each section is metioned below in parentheses.
			<ol>
				<li>Title (120)</li>
			...
			<p><strong>Examples of graphical abstracts:</strong>
				<a href="<?php echo base_url(); ?>images/Slide-1.jpg" target="_blank">Example 1</a>
				<a href="<?php echo base_url(); ?>images/Slide-2.jpg" target="_blank">Example 2</a>
				<a href="<?php echo base_url(); ?>images/Slide-3.jpg" target="_blank">Example 3</a>
				<a href="<?php echo base_url(); ?>images/Slide-4.jpg" target="_blank">Example 4</a>
				<a href="<?php echo base_url(); ?>images/Slide-5.jpg" target="_blank">Example 5</a>
				<a href="<?php echo base_url(); ?>images/Slide-6.jpg" target="_blank">Example 6</a>
				<a href="<?php echo base_url(); ?>images/Slide-7.jpg" target="_blank">Example 7</a>
			</p>
			...
			<p>Graphical abstracts need to be uploaded as a single image file (formats allowed include jpeg, png and gif) in addition to the textual abstract during the submission process. The easiest way to make your graphical abstract is to compose it on a single MS Powerpoint slide (as done in the examples)  and then save that slide as an image file (formats allowed include jpeg, tiff, and pdf) to submit. Participants are however free to use any method/software to make their graphical abstract as long as the final submitted file is one of the formats prescribed.  Before submitting, make sure that the graphical abstract is of adequate resolution to be easily readable.</p>
			...
			<?php if ($submitted == 1) { ?>
						<a href="#" class="abview">View Your Abstract</a>
				<?php } else { ?>
						<a href="#" class="absubmit">Submit Your Abstract</a>
				<?php } ?>
		...
		<div class="workshop">
			<h2>Workshops</h2>
			<p>Workshop registrations will open on 20th August. Please check the website for updates.Slide-		</div>

		<br><br><br><br><br><br><br><br><br>
		<div id="loaderspace">
			<div class="loading">
				<p>Please wait while we crunch this data. This might take a couple of minutes. <br>
				<br>
				<br> </p>
		...
		<script src="<?php echo base_url().'js/file-validator.js'; ?>"></script>
		<script>
...
// function to check length of values.
// (function($) {
//     $.fn.extend( {
...
$('input#gupload').fileValidator({
	onValidation: function(files){
		$(this).attr('class',''); 
		$(this).css({'backgroundColor' : 'green'});
	},
	onInvalid:    function(validationType, file){ 
		$(this).addClass('invalid'); console.log("invalid filetype"); 
		$(this).css({'backgroundColor' : '#ef4136'});
		alert("Invalid file type. Please make sure your file is an image file - .jpg, .jpeg, .png or .bmp and less than 1MB.");
	},
	maxSize:      '1m',
	type:         'image'
});
